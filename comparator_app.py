...
class App(tk.Tk):
    def __init__(self):
        ...
        # Highlighted input area (simple emerald look)
        box_outer = tk.Frame(root, background="#A7F3D0")      # emerald-300-ish
        box_inner = tk.Frame(box_outer, background="#ECFDF5")  # emerald-50-ish
    ...
    def compute_line(self):
        ...
        if any(x != x for x in (base_num, current_num)):  # NaN
            return ""
    ...
    def update_line(self, *args):
        ...
        if line:
            self.lbl_out.config(text=line, background="#ECFDF5")  # emerald-50-ish
